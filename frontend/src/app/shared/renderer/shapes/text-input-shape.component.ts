...
export class TextInputShapeComponent {
  ...
  protected label(): string {
    return stringProp(this.node().props, 'label', 'Short Text');
  }
  ...
  protected placeholder(): string {
    return stringProp(this.node().props, 'placeholder', 'Enter text...');
  }
